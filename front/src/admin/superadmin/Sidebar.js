...
const UsersIcon = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.67 3.137a4 4 0 00-5.665-5.665"
    />
  </svg>
);
...
const menuItems = [
  ...
  {
    path: "/main/sms-templates",
    label: "Sms Namunalari",
    icon: UsersIcon,
  },
  {
    path: "/main/qabul2025",
  ...
  return (
    <div className=" ">
      ...
      <button
        ...
        className="fixed top-4 left-2 z-50 p-2 text-gray-600 rounded-lg lg:hidden hover:bg-gray-100"
      >
        {sidebarOpen ? (
          // ❌ CLOSE ICON
          <svg
      ...
      >
        {/* Logo */}
        <div
          className={`flex items-center ${collapsed ? "justify-center px-1" : "justify-between px-2"} py-2 border-b border-gray-200 dark:border-gray-700`}
        >
          {!collapsed && (
          ...
          <ul className="space-y-2">
                ...
                <li key={index}>
                  ...
                  >
                    <div className="relative">
                      <Icon
                        className={`w-5 h-5 ${active ? "text-blue-600 dark:text-blue-400" : "text-gray-500 dark:text-gray-400 group-hover:text-blue-500"}`}
                      />
                      {item.badge && (
                    ...
                    {!collapsed && (
                      <>
                        <span
                          className={`ms-3 flex-1 ${active ? "font-semibold" : ""}`}
                        >
                          {item.label}
                        </span>
            ...
            <li className="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              >
                ...
                {!collapsed && (
                  <span className="ms-3 font-medium">Chiqish</span>
                )}
              </button>
            </li>
          </ul>
