...
const AdminHome = () => {
  ...
  const downloadGroupHisobot = async () => {
    try {
      ...
      const response = await fetch(`https://edu.bxu.uz/api/v1/hisobot/excel`, {
        method: "GET",
  ...
  const downloadAgentHisobot = async () => {
    try {
      ...
      const response = await fetch(
        `https://edu.bxu.uz/api/v1/hisobot/agent-statistic`,
        {
          method: "GET",
          headers: { Authorization: token ? `Bearer ${token}` : "" },
        }
  ...
  const fetchAgentDailyStats = async (agentPhone = "all") => {
    try {
      ...
      console.error(
        "Agentlarning kunlik statistikasini yuklashda xato:",
        error
      );
    }
  };
  ...
  const handleDownloadFilteredReport = async () => {
    ...
    try {
      ...
      console.error("Statistikani olishda xatolik:", error);
      alert(
        "Hisobot yuklab olishda xatolik yuz berdi. Iltimos, qayta urunib ko'ring."
      );
    } finally {
      setLoading(false);
    }
  ...
  const renderDailyStatsTable = () => (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
          <FiTrendingUp className="text-green-500" /> Kunlik ro'yxatdan o'tish
          statistikasi
        </h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {loading ? (
        ...
        >
          <div className="flex justify-between items-center mb-8">
            ...
            >
              {isRefreshing ? <LoadingSpinner /> : <FiRefreshCw size={18} />}
            ...
            <div className="flex items-center gap-4">
              <div className="border rounded-lg p-4">
                <p className="text-gray-700 mb-2">
                  <b>Guruhlar bo‘yicha hisobot:</b> ushbu tugma orqali har bir
                  guruh uchun alohida varaqlarga ega bo‘lgan Excel faylni yuklab
                  olasiz.
                </p>
                <button
                ...
                >
                  {loadingGroup
                    ? "Yuklanmoqda..."
                    : "📘 Guruhlar bo‘yicha hisobot olish"}
                </button>
              </div>

              <div className="border rounded-lg p-4">
                <p className="text-gray-700 mb-2">
                  <b>Agentlar bo‘yicha hisobot:</b> ushbu tugma orqali har bir
                  agent nomiga mos alohida varaqlar (sheetlar) hosil qilinadi.
                  Har bir agentga tegishli abituriyentlar ma’lumotlari Excel
                  faylga yoziladi.
                </p>
                <button
                ...
                >
                  {loadingGroup
                    ? "Yuklanmoqda..."
                    : "👥 Agentlar bo‘yicha hisobot olish"}
                </button>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
              <FiTrendingUp className="text-blue-500" /> Ro'yxatdan o'tish
              analitikasi
            </h2>
      ...
      {isGlobalLoading && <LoadingOverlay text="Hisobot yuklanmoqda..." />}
    </div>
  );
};
