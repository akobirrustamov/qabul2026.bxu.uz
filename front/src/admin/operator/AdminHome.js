          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (startDate === selectedEnd) {
                      alert(
                        "Boshlanish va tugash sanasi bir xil bo'lishi mumkin emas.",
                      );
                      return;
                    }
                    if (selectedEnd < startDate || selectedEnd > today) {
                      alert(
                        "Tugash sanasi boshlanish sanasidan keyin va bugungi kunga teng yoki kichik bo'lishi kerak.",
                      );
                      return;
                    }
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md flex items-center justify-center gap-2 transition-all ${
                  !selectedAgent || !startDate || loading
