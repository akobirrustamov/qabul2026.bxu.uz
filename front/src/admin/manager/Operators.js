        ...
        <div>
            ...
            <div className="p-10 sm:ml-64">
                                ...
                                <tr key={operator.id} className="hover:bg-gray-100">
                                    ...
                                    <td className="border border-gray-300 px-4 py-2">
                                        <input
                                            ...
                                            onChange={(e) => handleStatusStaff(operator.id, e.target.checked, operator.name)}
                                        />
                                    </td>
                ...
                <Modal open={isModalOpen} onClose={() => setIsModalOpen(false)} center>
                    <div>
                        <h2 className="text-xl mb-4">{editingId ? "Edit" : "Add"} Operator</h2>
                        <div className="mb-4">
                ...
                <Modal open={isConfirmationModalOpen} onClose={() => setIsConfirmationModalOpen(false)} center>
                    <div>
                        <h2 className="text-xl mb-4 pr-4">
                            {confirmationDetails?.name?.toUpperCase()} ning statusini rostdan ham o'zgartirmoqchimisiz?
                        </h2>
