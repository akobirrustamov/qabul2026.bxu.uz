...
function TestAbiturient() {
  ...
  const fetchTestData = async () => {
    try {
      ...
      if (response.data) {
        if (
          response.data.subject5.length === 0 ||
          response.data.subject5.length === 0
        ) {
          setShowTest(false);
          setIjodiy(true);
  ...
  const checkIfAllQuestionsAnswered = () => {
    ...
    if (ans) {
      const allAnswered = allQuestions.every((id) =>
        Object.keys(answers).includes(id.toString()),
      );
  ...
  const handleSubmitPassportInfo = async () => {
    const isValidPassportNumber = /^[A-Z]{2}\d{7}$/.test(
    ...
    if (!isValidPassportNumber) {
      alert(
        "Pasport raqami noto‘g‘ri formatda. (AA1234567 shaklida bo‘lishi kerak)",
      );
      return;
    }
    ...
    try {
      ...
      if (response.data.phone !== phone) {
        alert(
          `Kiritilgan pasport ma'lumotlari oldin ro'yxatdan o'tgan. Bog'langan telefon raqami: ${response.data.phone}`,
        );
        return;
      }
      ...
      alert(
        "Passport ma'lumotlarini saqlashda xatolik yuz berdi. Iltimos, qayta urinib ko'ring.",
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className={"pt-24 lg:pt-32 bg-[#F6F6F6]"}>
            ...
            <div className={""}>
              <div className="lg:flex gap-4 p-4 pt-0 w-full mx-auto lg:p-4">
                        ...
                        ...subjects[subjectKey].map((question, idx) => {
                          ...
                          return (
                            <div
                              ...
                              className="rounded-xl p-3 mb-4 bg-white"
                            >
                              <span className="font-semibold text-[#737373] text-xs lg:text-lg">
                                {globalIndex}-savol /
                              </span>
                              <span className="font-semibold text-[#737373] text-xs lg:text-lg">
                                {question.testSubject.name?.includes("_0")
                                  ? "1-blok"
                                  : "2-blok"}{" "}
                                / {question.testSubject.description}
                              </span>
                              <p className="text-base text-[#000000] lg:text-xl font-medium">
                                {question.question}
                              </p>
                              {shuffledAnswers[question.id]?.map(
                                (option, i) => (
                                  <label
                                    key={i}
                                    className={`flex items-center gap-1 text-sm lg:text-base rounde ${
                ...
                <div
                  className="col-span-1 md:col-span-2 w-full lg:w-2/6"
                  style={{
                    position: "sticky",
                    top: "0",
                    maxHeight: "100vh",
                ...
                >
                    ...
                    <div className="space-y-4 p-2 bg-white">
                      {Object.values(subjects)
                        ...
                        .reduce((acc, question, index) => {
                          const blocLabel = question.testSubject.name?.includes(
                            "_0",
                          )
                          ...
                          if (
                            !lastGroup ||
                            lastGroup.label !== blocLabel ||
                            lastGroup.questions.length >= 5
                          ) {
                            acc.push({
                              label: blocLabel,
                        ...
                        .map((group, groupIndex) => (
                          <div
                            key={groupIndex}
                            className="border-2 rounded-xl p-3 border-[#256DF6] bg-[#004CFF08]"
                          >
                  ...
                  text-center p-2 rounded-xl cursor-pointer`}
                    ...
                    <button
                      ...
                      className={`block mx-auto px-4 py-2 mb-4 rounded mt-4 font-semibold ${
                        canSubmit
          ...
          <div className={"pt-20 lg:pt-32 bg-[#F6F6F6] text-center"}>
            <Zoom>
              <div className={"px-4 m-4 mt-0 bg-cover  "}>
                <h3
                  className={"text-[#213972] xl:text-3xl md:text-xl sm:text-sm"}
                >
                  Siz testdan yetarli balni to'play olmadingiz.{" "}
                </h3>
                <h3
                  className={"text-[#213972] xl:text-3xl md:text-xl sm:text-sm"}
                >
                  {" "}
                  Sizning to'plagan balingiz: {formData.ball}{" "}
                </h3>
                <div>
                  <button
                    onClick={() => {
              ...
              <div className={""}>
                {ijodiy ? (
                  <div className={"pt-4 bg-[#F6F6F6] text-center"}>
                    <div
                      className={
                        "pt-20 lg:pt-32 bg-[#F6F6F6] text-center mx-auto max-w-4xl"
                      }
                    >
                      <h3
                        className={
                          "font-semibold text-4xl text-[#213972] lg:text-5xl"
                        }
                      >
                        Tabriklaymiz
                      </h3>
                      <h3
                        className={
                          "font-semibold text-[#213972] text-base lg:text-2xl mb-4"
                        }
                      >
                        Tabriklaymiz siz talabalar safiga qabul qilindingiz!
                        <br />
                        Sizni talabalar safimizda ko'rishimizdan xursand
                        bo'lamiz.
                      </h3>
                      ...
                      <h3 className="text-2xl font-medium text-[#154476] lg:text-4xl my-4">
                        Buxoro Xalqaro Universiteti manzili
                      </h3>
                  ...
                  <div className={"pt-4 bg-[#F6F6F6] text-center"}>
                    ...
                    >
                      ...
                      <div className="mb-2 bg-white mx-4 py-4 lg:py-10  lg:p-5 rounded-xl">
                        ...
                        <h3
                          className={
                            "font-semibold text-xl text-[#213972] lg:text-3xl"
                          }
                        >
                          {" "}
                          Sizning to'plagan balingiz: {formData.ball}
